...
// TestMouse_RealGeometryDragSetsDragging probes whether mouse hit-testing works
// end-to-end: render canvas, press inside a known-positioned card.
// If this test passes the production path should work too.
func TestMouse_RealGeometryDragSetsDragging(t *testing.T) {
	...
	press := tea.MouseMsg{X: 15, Y: headerRows + 6, Action: tea.MouseActionPress, Button: tea.MouseButtonLeft}
